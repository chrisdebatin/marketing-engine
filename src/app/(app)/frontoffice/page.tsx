...
/**
 * Frontoffice: das Callcenter loggt jeden Interessenten-Anruf (Lead) mit
 * Quelle und weitergeleitetem Standort — Lead-Zahlen und Quellen-Auswertung
 * für das Marketing.
 */
export default async function FrontofficePage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold">Frontoffice · Leads</h1>
        <p className="mt-1 text-sm text-muted-foreground">
          Für das Callcenter: Jeden Anruf eines Interessenten hier loggen —
          Quelle (woher aufmerksam geworden) und an welchen Standort
          weitergeleitet wurde. Daraus entstehen die Lead-Zahlen fürs
          Marketing.
        </p>
      </div>
